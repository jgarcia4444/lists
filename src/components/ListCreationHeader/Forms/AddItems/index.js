...
const AddItems = ({itemSubmitted, listName, list, newItemInfo, addItemClick, handleCompleteClick, handleSaveList, clearInput}) => {

    return (
        <div className="flex flex-row mt-12">
            <div className="w-1/2">
                <AddItemsForm clearInput={clearInput} itemSubmitted={itemSubmitted} addItemClick={addItemClick} newItemInfo={newItemInfo}/>
            </div>
