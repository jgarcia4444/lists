...
const AddItemsForm = ({newItemInfo, addItemClick, itemSubmitted, clearInput}) => {
    ...
    return (
        <div className="w-full flex justify-center">
            <div className="w-1/2 flex flex-col items-start">
                <HeaderInput clearInput={clearInput} itemSubmitted={itemSubmitted} valueInfo={newItemInfo} label={"New Item"} />
